...
#Código de importar imagenes

UPLOAD_FOLDER = os.path.abspath("./uploads/")
ALLOWED_EXTENSIONS = set(["png", "jpg", "jpeg", "gif", "pdf", "avif"])
...
#Código y URL para importar imágenes a la página
...
<a href="/ProyectoFinal" style="width: 60px; height: 60px; background-color: green; color: white;">home</a>
"""
